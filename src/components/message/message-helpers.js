 ...
 */
function OutboundMessage({ message, isLast, lastMessageRef, handleQuickReply, serviceName }) {
  return (
    <div ref={isLast ? lastMessageRef : null}>
      <OutboundTextMessage
        message={message}
...
export function renderMessage(message, index, isLast, lastMessageRef, handleQuickReply, serviceName) {
